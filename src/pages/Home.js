        ...
        <Container fluid={true}>
          ...
          <Row>
            <Col md={{ span: 11, offset: 1 }}>
              <Link className="btn btn-inverse" to="/about">
                about us
              </Link>
              <Link className="btn btn-inverse ml-1" to="/sponsors">
                sponsors
              </Link>
              <Link className="btn btn-inverse ml-1" to="/team">
                our team
              </Link>
              <Link className="btn btn-inverse ml-1" to="/contact">
                contact us
              </Link>
            </Col>
          </Row>
      ...
      <Container>
        ...
        <Row>
          <Col md={{ span: 8, offset: 2 }}>
            <hr />
            <p>
              Solar Gators is a University of Florida student organization
              driven by passionate engineers and designers determined to win the
      ...
      <Container className="container-home-cards p-0">
        <Row className="section">
          ...
          <HomeCard
            ...
            link="/team"
          >
            Solar Gators is a University of Florida student organization driven
            by passionate engineers and designers determined to win the Formula
            Sun Grand Prix.
          </HomeCard>
          ...
          <HomeCard
            ...
            link="/events"
          >
            Solar Gators provides many opportunities and activities. Find out
            when and where.
          </HomeCard>
          <HomeCard
            index={3}
