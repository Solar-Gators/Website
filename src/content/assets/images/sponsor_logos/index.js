...
import ProtoPasta from './Protopasta.png'
import SainSmart from './SainSmart.png'
...
let gold3 = [[MatrixComposities, "https://matrixcomp.com"], [ElektroAutomatik, "https://elektroautomatik.com/"], [Molex, "https://www.molex.com"],
    [Solidworks, "https://www.solidworks.com/"], [Bridgestone, "https://www.bridgestoneamericas.com/en/index"], [RoyalElements,"https://royal-elements.com/"]];
...
let bronze3 = [[MerritSupply, "https://www.merrittsupply.com/"], [WestSystems, "https://www.westsystem.com/"],
    ...
    [CustomDynamics, "https://www.customdynamics.com/"], [ExtremeCanopy, "https://www.extremecanopy.com/"], [Actisense, "https://actisense.com/"]];
...
export const get_valued_sponsors = (carNum) => {
    if (carNum === "3") { return valued3; }
    else if (carNum === "4") { return valued4; }
    else { return ""; }
}
